...
ActiveRecord::Schema.define(version: 20150128060759) do
  ...
  create_table "metrics", id: :uuid, default: "uuid_generate_v4()", force: :cascade do |t|
    ...
    t.string   "request_action",       limit: 255
    t.string   "request_controller",   limit: 255
    t.string   "request_ip",           limit: 255
    t.string   "request_method",       limit: 255
    t.string   "request_referrer",     limit: 255
    t.string   "request_requestor_ip", limit: 255
    t.string   "request_url",          limit: 255
    t.string   "request_user_agent",   limit: 255
    t.string   "request_xff",          limit: 255
    t.uuid     "user_id"
