...
ActiveRecord::Schema.define(version: 20_140_831_020_534) do
  ...
  add_index 'network_affiliations', %w(network_id user_group_id), name: 'index_network_affiliations_on_network_id_and_user_group_id', using: :btree
  ...
  add_index 'profiles', %w(latitude longitude), name: 'index_profiles_on_latitude_and_longitude', using: :btree
  ...
  add_index 'source_histories', %w(source_id user_group_id), name: 'index_source_histories_on_source_id_and_user_group_id', using: :btree
  ...
  add_index 'user_group_memberships', %w(user_id user_group_id), name: 'index_user_group_memberships_on_user_id_and_user_group_id', using: :btree
