VCR.configure do |c|
  ...
  # Twitter
  filters += %w(TWITTER_ACCESS_TOKEN TWITTER_ACCESS_TOKEN_SECRET TWITTER_ACCOUNT_ID TWITTER_API_KEY TWITTER_API_SECRET TWITTER_CONSUMER_KEY TWITTER_CONSUMER_SECRET TWITTER_OAUTH_SECRET TWITTER_OAUTH_TOKEN TWITTER_OWNER TWITTER_OWNER_ID)
